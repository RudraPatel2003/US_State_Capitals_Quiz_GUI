...
#find the desired table, identified by its unique caption
desired_table = None
for table in tables_with_captions:
    if (table.caption.string).strip() == "Population of states, territories, divisions and regions":
        desired_table = table
        break


#find all of the rows in the desired table
